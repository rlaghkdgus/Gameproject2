...
public class T_ShootingManager : Singleton<T_ShootingManager>
{
    ...
    private void Awake()
    {
        T_GameManager.Instance.S_State.onChange += Shootingbird;
        T_GameManager.Instance.player[0].pState.onChange += SetBird;
        T_GameManager.Instance.player[1].pState.onChange += SetBird;
    }
    ...
    IEnumerator DestroyGBird()
    {
        if (T_TurnSys.Instance.sPlayerIndex.Value == 0)
        {
            if (T_GameManager.Instance.player[0].stairCheck == true || T_GameManager.Instance.player[0].tripleCheck == true)
            {
                for (int i = 2; i >= 0; i--)
                {
                    Destroy(p2Bird[i]);
            ...
            else if (T_GameManager.Instance.player[0].doubleCheck == true)
            {
                for (int i = 1; i >= 0; i--)
                {
                    Destroy(p2Bird[i]);
        ...
        {
            if (T_GameManager.Instance.player[1].stairCheck == true || T_GameManager.Instance.player[1].tripleCheck == true)
            {
                for (int i = 2; i >= 0; i--)
                {
                    Destroy(p1Bird[i]);
            ...
            else if (T_GameManager.Instance.player[1].doubleCheck == true)
            {
                for (int i = 1; i >= 0; i--)
                {
                    Destroy(p1Bird[i]);
